...
const eventTasks = [
  {
    ...
    title: "Open Day",
    description: "Plan and coordinate university open day activities.",
  },
  {
    icon: <MapPin className="w-5 h-5 text-primary" />,
    title: "Education Fair",
    description: "Set up booths and manage outreach during fairs.",
  },
  {
    icon: <Mic2 className="w-5 h-5 text-primary" />,
    title: "School Visit",
    description: "Conduct school outreach programs and share information.",
  },
  {
    icon: <Users className="w-5 h-5 text-primary" />,
    title: "Event Coordination",
    description: "Manage logistics, brief volunteers, and oversee execution.",
  },
];
...
const EmuTasks = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto text-center mb-10">
        <CalendarDays className="w-10 h-10 mx-auto text-primary mb-4" />
        ...
        <p className="text-sm sm:text-base md:text-lg text-neutral-700 dark:text-neutral-300 mb-8 md:mb-12 max-w-2xl mx-auto">
          Organizing university events, school visits, and external exhibitions
