...
import { Image, Video, PencilLine, Share2 } from "lucide-react";
...
const marketingTasks = [
  {
    ...
    title: "Poster Design",
    description: "Create engaging posters for university events and promos.",
  },
  {
    icon: <Video className="w-5 h-5 text-primary" />,
    title: "Video Content",
    description: "Edit and produce reels for TikTok, Instagram & Facebook.",
  },
  {
    icon: <PencilLine className="w-5 h-5 text-primary" />,
    title: "Captions & Hashtags",
    description: "Write effective captions and hashtag strategies.",
  },
  {
...
const DsmmTasks = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto text-center mb-10">
        <Image className="w-10 h-10 mx-auto text-primary mb-4" />
        ...
        <p className="text-sm sm:text-base md:text-lg text-neutral-700 dark:text-neutral-300 mb-8 md:mb-12 max-w-2xl mx-auto">
          Creating visual content and managing posts across social platforms
          like Instagram, Facebook, and TikTok.
        </p>
      </div>

      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {marketingTasks.map((item, index) => (
          <motion.div
            key={index}
